...
namespace DependencyProperties
{
  ...
  public class TextLabelHu : FrameworkElement
  {
      public static readonly DependencyProperty FontSizeProperty;
      public static readonly DependencyProperty TextProperty;
      ...
      static TextLabelHu()
      {
          PropertyMetadata meta = new FrameworkPropertyMetadata(34.0, FrameworkPropertyMetadataOptions.AffectsMeasure);

          FontSizeProperty = Control.FontSizeProperty.AddOwner(typeof (TextLabelHu), meta);
         


            TextProperty = TextLabel.TextProperty.AddOwner(typeof(TextLabelHu));
